...
| Terms and Conditions text | Supplied by the client 11 Sep 2026 (the live text, last updated 15 Nov 2024) and published verbatim at `/terms-and-conditions/` with the address changed to the Greenwood Village office per the client. Still a generic template (subscriptions, 30-day free trial, return policy, Texas courts, phone 832-805-0387, `cmartin@ssifinalexpense.com`); flag for counsel when convenient, but it is the client's current document. | `/terms-and-conditions/` | supplied |
| Address in the legal documents | Client confirmed 11 Sep 2026: 5775 DTC Blvd, Suite 250-S, Greenwood Village, CO 80111 everywhere. Privacy policy and terms updated accordingly (the terms' "registered in Colorado at" line now carries this address). The privacy policy's Google Analytics / AdSense paragraphs remain as supplied although this site loads neither. | `/privacy/`, `/terms-and-conditions/` | supplied |
